...
- https://github.com/natty-parser/natty[natty]. In one or two projects we had 'natty' as a dependency for 'natural language parsing'. The project was abandoned and a fork is maintained now here.
